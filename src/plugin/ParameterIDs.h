...
// ------------------------------------------------------------------ modulation sources
juce::String lfoRate(int i);      juce::String lfoSync(int i);
juce::String lfoPhase(int i);     juce::String lfoSmooth(int i);
juce::String lfoSteps(int i);     juce::String lfoDepth(int i);

juce::String egAttack(int i);     juce::String egDecay(int i);
juce::String egSustain(int i);    juce::String egRelease(int i);
juce::String egThreshold(int i);  juce::String egTrigger(int i);

juce::String efAttack(int i);     juce::String efRelease(int i);
juce::String efBand(int i);       juce::String efGain(int i);

inline constexpr const char* xyX = "xyX";
inline constexpr const char* xyY = "xyY";

juce::String midiType(int i);     juce::String midiCC(int i);
