...
![The Ember interface: preset bar, global controls, spectrum display with draggable crossovers, the selected band's controls, and the collapsible modulation panel.](docs/images/ember-ui.png)

*Generated by `ember_rendereditor`, which renders the real editor offscreen — see [docs/TESTING.md](docs/TESTING.md).*
